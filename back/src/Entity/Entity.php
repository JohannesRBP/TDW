...
class Entity extends Element
{
    ...
    /* Associations where this entity is a member */
    ...
    /**
     * Gets the associations this entity belongs to
     *
    ...
    /**
     * Determines if the entity belongs to an association
     *
    ...
    /**
     * Remove entity from an association
     *
     * @param Association $association
    ...
    {
        $removed = $this->associations->removeElement($association);
        if ($removed) {
