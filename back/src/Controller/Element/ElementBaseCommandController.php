...
abstract class ElementBaseCommandController
{
    ...
    /**
     * Crea el objeto usando los datos recibidos.
     * Se sobrescribe en controladores específicos para adaptar la creación.
     *
     * @param array<string,string> $data
     * @return ElementInterface
     * @throws \InvalidArgumentException si falta "name"
     */
    protected function createElementFromData(array $data): ElementInterface
    {
        if (!isset($data['name'])) {
            throw new \InvalidArgumentException('Falta "name".');
        }
        /** @var class-string<ElementFactory> $factory */
        $factory = static::getFactoryClassName();
        return $factory::createElement($data['name']);
    }
    ...
    public function post(Request $request, Response $response): Response
    {
        ...
        try {
            $element = $this->createElementFromData($req_data);
        ...
        // Genera el ETag a partir de la representación JSON del elemento
